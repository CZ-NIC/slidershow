...
* feat (properties): <kbd>Alt+[</kbd> / <kbd>Alt+]</kbd> mark a video's trim start/end (`sli-video-cut`) at the current playback time without opening the panel at all; both are undoable
